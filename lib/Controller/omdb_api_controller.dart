...
class OmdbApiController {
  ...
  String allDataApiUrl = 'http://www.omdbapi.com/?apikey=b3087fac&';//key: b3087fac
  ...
  Future<List<MoviesModel>> searchMovieWithDifferentPage(String text, int actualPage) async {
    final response = await getApiDataByString(allDataApiUrl+"s="+text+"&page=$actualPage");
    var json = jsonDecode(response.body);
